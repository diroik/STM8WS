...
inline void Init_Discrete(void)
{
  ...
  /*
  DISCRETE[0].REG = &PC_IDR; DISCRETE[0].BIT = BIT3;
  DISCRETE[1].REG = &PC_IDR; DISCRETE[1].BIT = BIT2;
  DISCRETE[2].REG = &PC_IDR; DISCRETE[2].BIT = BIT1;
  DISCRETE[3].REG = &PE_IDR; DISCRETE[3].BIT = BIT5;
  DISCRETE[4].REG = &PB_IDR; DISCRETE[4].BIT = BIT4;
  DISCRETE[5].REG = &PB_IDR; DISCRETE[5].BIT = BIT5;
  DISCRETE[6].REG = &PB_IDR; DISCRETE[6].BIT = BIT6;
  DISCRETE[7].REG = &PB_IDR; DISCRETE[7].BIT = BIT7;
 ...
 */
  ...
  DISCRETE[0].REG = &PD_IDR; DISCRETE[0].BIT = BIT0;
  DISCRETE[1].REG = &PD_IDR; DISCRETE[1].BIT = BIT2;
  DISCRETE[2].REG = &PD_IDR; DISCRETE[2].BIT = BIT3;
  DISCRETE[3].REG = &PD_IDR; DISCRETE[3].BIT = BIT4;
  DISCRETE[4].REG = &PD_IDR; DISCRETE[4].BIT = BIT7;
  DISCRETE[5].REG = &PA_IDR; DISCRETE[5].BIT = BIT1;
  DISCRETE[6].REG = &PA_IDR; DISCRETE[6].BIT = BIT3;
  DISCRETE[7].REG = &PF_IDR; DISCRETE[7].BIT = BIT4;
  
  DISCRETE[8].REG  = &PC_IDR; DISCRETE[8].BIT  = BIT3;
  DISCRETE[9].REG  = &PC_IDR; DISCRETE[9].BIT  = BIT2;
  DISCRETE[10].REG = &PC_IDR; DISCRETE[10].BIT = BIT1;
  DISCRETE[11].REG = &PE_IDR; DISCRETE[11].BIT = BIT5;
  DISCRETE[12].REG = &PB_IDR; DISCRETE[12].BIT = BIT4;
  DISCRETE[13].REG = &PB_IDR; DISCRETE[13].BIT = BIT5;
  DISCRETE[14].REG = &PB_IDR; DISCRETE[14].BIT = BIT6;
  DISCRETE[15].REG = &PB_IDR; DISCRETE[15].BIT = BIT7;
